...
type iceDevice struct {
	link          *netlink.Vxlan
	directRouting bool
}

func newIceDevice(devAttrs *iceDeviceAttrs) (*iceDevice, error) {
	link := &netlink.Vxlan{
...
func ensureLink(vxlan *netlink.Vxlan) (*netlink.Vxlan, error) {
	...
	if err == syscall.EEXIST {
		...
		log.V(1).Infof("ICE vxlan device already exists")
...
func (dev *iceDevice) Configure(ipn ip.IP4Net) error {
...
func (dev *iceDevice) MACAddr() net.HardwareAddr {
...
func (dev *iceDevice) AddFDB(n neighbor) error {
...
func (dev *iceDevice) DelFDB(n neighbor) error {
...
func (dev *iceDevice) AddARP(n neighbor) error {
...
func (dev *iceDevice) DelARP(n neighbor) error {
